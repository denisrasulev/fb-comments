...
This disclaimer governs the use of this report. Your reading of the rest of the report, in addition to the disclaimer, means your acceptance of the terms of the disclaimer in full.

While the expert has made every attempt possible to ensure the accuracy and reliability of the information provided in this report, this information is provided "as is", with no guarantee of completeness, accuracy, timeliness or the results obtained from the use of this information. No warranties, promises and/or representations of any kind, expressed or implied, are given as to the nature, standard, accuracy or otherwise of the information provided in this report nor to the suitability or otherwise of the information to your particular circumstances.

The expert does not accept any responsibility or liability for the accuracy, content, completeness, legality, or reliability of the information contained on this report, any errors or omissions, any loss or damage of whatever nature (direct, indirect, consequential, or other) whether arising in contract, tort or otherwise, which may arise as a result of your use of (or inability to use) this report, or from your use of (or failure to use) the information in this report, even if advised of the possibility of such damages.

This report provides links to other sites owned by third parties. The content of such third party sites is not within expert's control, and expert cannot and will not take responsibility for the information or content thereon. Links to such third party sites are not to be taken as an endorsement by the expert of the third party site, or any products promoted, offered or sold on the third party site, nor that such sites are free from computer viruses or anything else that has destructive properties.

In this disclaimer, "expert" means Denis Rasulev of Bratislava, Slovakia.
